...
declare const enum GMSAutocompleteBoundsMode {
	...
	kGMSAutocompleteBoundsModeBias = 0,

	kGMSAutocompleteBoundsModeRestrict = 1
}
...
declare class GMSAutocompleteFetcher extends NSObject {
	...
	autocompleteBoundsMode: GMSAutocompleteBoundsMode;
...
declare class GMSPlacesClient extends NSObject {
	...
	autocompleteQueryBoundsBoundsModeFilterCallback(query: string, bounds: GMSCoordinateBounds, boundsMode: GMSAutocompleteBoundsMode, filter: GMSAutocompleteFilter, callback: (p1: NSArray<GMSAutocompletePrediction>, p2: NSError) => void): void;
	...
	findAutocompletePredictionsFromQueryBoundsBoundsModeFilterSessionTokenCallback(query: string, bounds: GMSCoordinateBounds, boundsMode: GMSAutocompleteBoundsMode, filter: GMSAutocompleteFilter, sessionToken: GMSAutocompleteSessionToken, callback: (p1: NSArray<GMSAutocompletePrediction>, p2: NSError) => void): void;
